...
def get_section_opics_project_code(optics_branch, proj, project_branch,  pull_time_root_name):
    ...
    s += f'        echo " - "\n'
    s += f'        echo echo "NOTE - SUCCESSFULLY PULLED IN DOWNWARD... attempting downward build..."\n'
    s += f'        echo " - "\n'
    s += f'        gcc --version\n'
    s += f'        apt update\n'
    ...
    s += f'    else\n'
    s += f'        echo " - "\n'
    s += f'        echo "NOTE - DID NOT DETECT MULTI_TOOL downward SUBMODULE REFERENCE"\n'
    s += f'        echo " - "\n'
    s += f'    fi\n'

    # s += f'    if [ -f /{proj_pull_dir}/opics_inter/inter/planner/pddl/pddlstream/.gitmodules ]; then \n'
    # s += f'        echo " - "\n'
    # s += f'        echo "NOTE - DETECTED MULTI_TOOL downward SUBMODULE REFERENCE - attempting to pull that in..."\n'
    # s += f'        echo " - "\n'
    # s += f'        cd /{proj_pull_dir}/opics_inter/inter/planner/pddl/pddlstream_local\n'
    # s += f'        git submodule update --init --recursive\n'
    # s += f'        if [ -f /{proj_pull_dir}/opics_inter/inter/planner/pddl/pddlstream_local/downward/build.py ]; then \n'
    # s += f'            echo " - "\n'
