...
CONTAINER_PULL_ROOT_PREFIX='image_'
RUN_SYSTEM_PREFIX='test_'
...
def section_run_script(optics_spec_fname):
    s =  f'    echo "...cd $OPICS_HOME/scripts/optics/apptainer"\n'
    s += f'    cd $OPICS_HOME/scripts/optics/apptainer\n'
    s += F'    echo "...invoking container_run"\n'
    s += f'    python3 container_run.py\n'
    return s
...
if __name__ == '__main__':
    ...
    section_run_script         = section_run_script(optics_spec_fname)
