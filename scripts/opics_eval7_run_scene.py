...
container_for_project['avoe' ] = 'avoe_120423_eval7.sif'
container_for_project['inter'] = 'inter_120423_eval7.sif'
...
def usage():
    print('usage:  python opics_eval7_run_scene.py --scene <scene_path>')
